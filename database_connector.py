...
def Insert_OcrKeywordlog(FileName, KeyId, Keytype, clientid, priority):
    db = connect_to_db()
    cursor = db.cursor()
...
def Insert_OcrProcess(FileName=None, Status=None, Pubid=None, Pubdate=None, PageNo=None,
                      Processed=None, Title=None, FolderPath=None, Full_Text=None, Date_folder=None,
                      articleid=None, copied=None, Title2=None):
    db = connect_to_db()
    cursor = db.cursor()
    ...
    insert_values = (FileName, Date_Time, Status, Pubid, Pubdate, PageNo, Processed, Title, FolderPath, Full_Text, Date_folder, articleid, copied, Title2)
